...
class _SpaceFrameWidgetState extends State<SpaceFrameWidget> {
  ...
  void _showRatingDialog() {
    if (ApiService.currentUser == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please login first to rate'))
      );
      return;
    }
        ...
        return StatefulBuilder(
          builder: (context, setStateDialog) {
            return AlertDialog(
              ...
              title: const Text("Rate this space"),
              content: Column(
              ...
              actions: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    try {
                      await ApiService.rateSpace(widget.space.id, selectedRating);
                      if (mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              const SizedBox(width: 4),
                              Text(
                                "${space.rating} (${space.noOfRating.toInt()} reviews) • Rate",
                                style: TextStyle(
